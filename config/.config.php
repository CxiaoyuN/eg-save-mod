...
//
// !!! 修改此key为随机字符串确保网站安全 !!!
$System_Config['key'] = 'hbhsbashdhjhhuih127y7sbhbahduvu2ybhj';
$System_Config['debug'] =  'false';  //  正式环境请确保为false
$System_Config['appName'] = 'WZName';             //站点名称
$System_Config['baseUrl'] = 'https://yuming';            // 站点地址
...
$System_Config['muKey'] = 'QHKEY';
// 邮件
$System_Config['mailDriver'] = 'smtp';   // mailgun or smtp or sendgrid

// 用户签到设置
$System_Config['checkinMin'] = '20';       // 签到最少流量 单位MB
...
$System_Config['db_password'] = 'sspanelpasswd';
...
# smtp
$System_Config['smtp_host'] = 'smtp.qq.com';           #这是QQ邮箱的前缀代码（除非你不是QQ邮箱，否则不要删）
$System_Config['smtp_username'] = 'useremail';         #邮箱使用者名称（QQ邮箱）
$System_Config['smtp_port'] = '465';                   #邮箱端口（QQ邮箱）
$System_Config['smtp_name'] = 'useremail';             #邮箱名称（QQ邮箱）
$System_Config['smtp_sender'] = 'useremail';           #邮箱发件者（QQ邮箱）
$System_Config['smtp_passsword'] = 'stmpmm';           #邮箱密码（QQ邮箱申请的smtp密码）
$System_Config['smtp_ssl'] = 'true';                   #默认开启 
...
#功能开关
$System_Config['enable_wecenter']='true';
...
#Radius数据库设置
$System_Config['radius_db_host']='localhost';               #radius所在数据库IP
$System_Config['radius_db_database']='radius';              #radius数据库名
$System_Config['radius_db_user']='radius';                  #radius数据库用户名
$System_Config['radius_db_password']='radiuspassword';      #radius数据库密码
...
$System_Config['wecenter_db_database']='wecenterdatabase';
$System_Config['wecenter_db_user']='wecenteruser';
$System_Config['wecenter_db_password']='wecenterpassword';

#系统根域名 zhaoj.in 这样
$System_Config['wecenter_system_main_domain']='ym';

#访问路径，不开启这个功能的话就清空这个设置项吧
$System_Config['wecenter_url']='https://wecenterym';
...
$System_Config['auto_backup_email']='beifenemail';
$System_Config['auto_backup_webroot']='/home/wwwroot/backups';
$System_Config['auto_backup_passwd']='zippassword';
